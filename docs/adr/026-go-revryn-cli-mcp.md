...
Implement the public CLI in Go with Cobra and implement MCP in the same Go module using the official Tier-1 MCP Go SDK. Package `revryn` in the official OCI image and publish native binaries separately. Phoenix remains the application/domain runtime.
